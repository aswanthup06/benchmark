  ...
  return (
    <div className="px-4 sm:px-6 md:px-8 lg:px-28 mb-32">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 ">
        ...
        <div className="flex flex-wrap md:justify-end lg:justify-center">


          <div className="relative flex-wrap flex lg:flex-col gap-6 h-fit">
            ...
            <div className="z-10 lg:absolute lg:left-[-150px] lg:top-1/2 lg:-translate-y-1/2 lg:mt-0">
              <div className="w-full md:w-[350px] h-[190px] relative">
                <img
                  className="w-full h-full object-cover rounded-xl"
